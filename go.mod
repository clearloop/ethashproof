module github.com/darwinia-network/ethashproof
...
require (
	...
	github.com/tranvictor/ethashproof v0.0.0-20200216154736-82a2b716eac4
	github.com/tranvictor/ethutils v0.0.0-20190206090902-f90588fe868e
